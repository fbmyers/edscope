...
//FBM
- (FKImageUploadNetworkOperation *) uploadImageWithData:(NSData *)imageData args:(NSDictionary *)args completion:(FKAPIImageUploadCompletion)completion {
    
	FKImageUploadNetworkOperation *imageUpload = [[FKImageUploadNetworkOperation alloc] initWithData:imageData arguments:args completion:completion];
	[[FKDUNetworkController sharedController] execute:imageUpload];
    return imageUpload;
}
